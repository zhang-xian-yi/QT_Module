...
AbstractEntity* AbstractEntity::m_highlightedObject = nullptr;
AbstractEntity* AbstractEntity::m_selectedObject = nullptr;
...
void AbstractEntity::setHighlighted(bool highlighted) {
    ...
    if (Load3dModelNS::LMGlobalData::GetInstance().log_level >= LOG_LEVEL_INFO && highlighted)
...
void AbstractEntity::setSelected(bool selected) {
    ...
    if (Load3dModelNS::LMGlobalData::GetInstance().log_level >= LOG_LEVEL_INFO && selected)
